...
(idef-definitions
 (WITH-PREFIX "omg.org"
    (DEFINE-MODULE "CORBA" NIL
      (DEFINE-TYPE "Identifier" STRING)
      (DEFINE-TYPE "ScopedName" STRING)
      (DEFINE-TYPE "RepositoryId" STRING)
      ...
      (DEFINE-INTERFACE "Contained" (:BASES ("CORBA::IRObject"))
        ...
        (DEFINE-ATTRIBUTE "containing_repository" "CORBA::Repository" :READONLY
          T)
        (DEFINE-STRUCT "Description"
          (("kind" "CORBA::DefinitionKind") ("value" ANY)))
        (DEFINE-OPERATION "describe" NIL :RESULT-TYPE "Description" :EXCEPTIONS
          NIL)
        (DEFINE-OPERATION "move"
      ...
      (DEFINE-TYPE "InterfaceDefSeq" (SEQUENCE "InterfaceDef" 0))
      (DEFINE-TYPE "ContainedSeq" (SEQUENCE "Contained" 0))
      (DEFINE-STRUCT "StructMember"
        (("name" "Identifier") ("type" TYPECODE) ("type_def" "IDLType")))
      (DEFINE-TYPE "StructMemberSeq" (SEQUENCE "StructMember" 0))
      (DEFINE-STRUCT "UnionMember"
        (("name" "Identifier") ("label" ANY) ("type" TYPECODE)
          ("type_def" "IDLType")))
      (DEFINE-TYPE "UnionMemberSeq" (SEQUENCE "UnionMember" 0))
      (DEFINE-TYPE "EnumMemberSeq" (SEQUENCE "Identifier" 0))
      (DEFINE-INTERFACE "Container" (:BASES ("CORBA::IRObject"))
        (DEFINE-OPERATION "lookup"
          ((:PARAM_IN "search_name" "CORBA::ScopedName"))
          :RESULT-TYPE "CORBA::Contained" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "contents"
          ((:PARAM_IN "limit_type" "CORBA::DefinitionKind")
            (:PARAM_IN "exclude_inherited" BOOLEAN))
          :RESULT-TYPE "CORBA::ContainedSeq" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "lookup_name"
          ...
          :RESULT-TYPE "CORBA::ContainedSeq" :EXCEPTIONS NIL)
        (DEFINE-STRUCT "Description"
          (("contained_object" "CORBA::Contained")
            ("kind" "CORBA::DefinitionKind") ("value" ANY)))
        (DEFINE-TYPE "DescriptionSeq" (SEQUENCE "Description" 0))
        (DEFINE-OPERATION "describe_contents"
          ((:PARAM_IN "limit_type" "CORBA::DefinitionKind")
            (:PARAM_IN "exclude_inherited" BOOLEAN)
            (:PARAM_IN "max_returned_objs" LONG))
          :RESULT-TYPE "DescriptionSeq" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_module"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec"))
          :RESULT-TYPE "CORBA::ModuleDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_constant"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "type" "CORBA::IDLType") (:PARAM_IN "value" ANY))
          :RESULT-TYPE "CORBA::ConstantDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_struct"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "members" "CORBA::StructMemberSeq"))
          :RESULT-TYPE "CORBA::StructDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_exception"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "members" "CORBA::StructMemberSeq"))
          :RESULT-TYPE "CORBA::ExceptionDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_union"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "discriminator_type" "CORBA::IDLType")
            (:PARAM_IN "members" "CORBA::UnionMemberSeq"))
          :RESULT-TYPE "CORBA::UnionDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_enum"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "members" "CORBA::EnumMemberSeq"))
          :RESULT-TYPE "CORBA::EnumDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_alias"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "original_type" "CORBA::IDLType"))
          :RESULT-TYPE "CORBA::AliasDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_interface"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "base_interfaces" "CORBA::InterfaceDefSeq"))
          :RESULT-TYPE "CORBA::InterfaceDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "locate_id" ((:PARAM_IN "id" "CORBA::RepositoryId"))
          :RESULT-TYPE "CORBA::Contained" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "locate_name"
          ((:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "include_enclosing_scopes" BOOLEAN)
            (:PARAM_IN "is_first_level" BOOLEAN))
          :RESULT-TYPE "CORBA::Contained" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "remove_contained"
          ((:PARAM_IN "con" "CORBA::Contained")) :RESULT-TYPE VOID :EXCEPTIONS
          NIL)
        (DEFINE-OPERATION "add_contained"
          ((:PARAM_IN "con" "CORBA::Contained")) :RESULT-TYPE VOID :EXCEPTIONS
          NIL))
      ...
      (DEFINE-TYPE "IDLTypeSeq" (SEQUENCE "IDLType" 0))
      (DEFINE-INTERFACE "Repository" (:BASES ("CORBA::Container"))
        (DEFINE-OPERATION "lookup_id"
          ((:PARAM_IN "search_id" "CORBA::RepositoryId")) :RESULT-TYPE
          "CORBA::Contained" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "get_primitive"
          ((:PARAM_IN "kind" "CORBA::PrimitiveKind")) :RESULT-TYPE
          "CORBA::PrimitiveDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_string" ((:PARAM_IN "bound" ULONG))
          :RESULT-TYPE "CORBA::StringDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_wstring" ((:PARAM_IN "bound" ULONG))
          :RESULT-TYPE "CORBA::WstringDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_sequence"
          ((:PARAM_IN "bound" ULONG)
            (:PARAM_IN "element_type" "CORBA::IDLType"))
          :RESULT-TYPE "CORBA::SequenceDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_array"
          ((:PARAM_IN "length" ULONG)
            (:PARAM_IN "element_type" "CORBA::IDLType"))
          :RESULT-TYPE "CORBA::ArrayDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_fixed"
          ((:PARAM_IN "digits" USHORT) (:PARAM_IN "scale" SHORT)) :RESULT-TYPE
          "CORBA::FixedDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "get_anonymous_types" NIL :RESULT-TYPE
          "CORBA::IDLTypeSeq" :EXCEPTIONS NIL))
      (DEFINE-INTERFACE "ModuleDef"
        (:BASES ("CORBA::Container" "CORBA::Contained")))
      (DEFINE-STRUCT "ModuleDescription"
        (("name" "Identifier") ("id" "RepositoryId")
          ("defined_in" "RepositoryId") ("version" "VersionSpec")))
      ...
      (DEFINE-INTERFACE "FixedDef" (:BASES ("CORBA::IDLType"))
        (DEFINE-ATTRIBUTE "digits" USHORT)
        (DEFINE-ATTRIBUTE "scale" SHORT))
      ...
      (DEFINE-STRUCT "AttributeDescription"
        (("name" "Identifier") ("id" "RepositoryId")
          ("defined_in" "RepositoryId") ("version" "VersionSpec")
          ("type" TYPECODE) ("mode" "AttributeMode")))
      ...
      (DEFINE-STRUCT "ParameterDescription"
        (("name" "Identifier")
         ...
         ("type_def" "IDLType")
         ("mode" "ParameterMode")))
      (DEFINE-TYPE "ParDescriptionSeq" (SEQUENCE "ParameterDescription" 0))
      (DEFINE-TYPE "ContextIdentifier" "Identifier")
      (DEFINE-TYPE "ContextIdSeq" (SEQUENCE "ContextIdentifier" 0))
      (DEFINE-TYPE "ExceptionDefSeq" (SEQUENCE "ExceptionDef" 0))
      (DEFINE-TYPE "ExcDescriptionSeq" (SEQUENCE "ExceptionDescription" 0))
      ...
      (DEFINE-STRUCT "OperationDescription"
        (("name" "Identifier") ("id" "RepositoryId")
          ("defined_in" "RepositoryId") ("version" "VersionSpec")
          ("result" TYPECODE) ("mode" "OperationMode")
          ("contexts" "ContextIdSeq") ("parameters" "ParDescriptionSeq")
          ("exceptions" "ExcDescriptionSeq")))
      (DEFINE-TYPE "RepositoryIdSeq" (SEQUENCE "RepositoryId" 0))
      (DEFINE-TYPE "OpDescriptionSeq" (SEQUENCE "OperationDescription" 0))
      (DEFINE-TYPE "AttrDescriptionSeq" (SEQUENCE "AttributeDescription" 0))
      (DEFINE-INTERFACE "InterfaceDef"
        ...
        (DEFINE-OPERATION "describe_interface" NIL :RESULT-TYPE
          "FullInterfaceDescription" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_attribute"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
            (:PARAM_IN "type" "CORBA::IDLType")
            (:PARAM_IN "mode" "CORBA::AttributeMode"))
          :RESULT-TYPE "CORBA::AttributeDef" :EXCEPTIONS NIL)
        (DEFINE-OPERATION "create_operation"
          ((:PARAM_IN "id" "CORBA::RepositoryId")
            (:PARAM_IN "name" "CORBA::Identifier")
            (:PARAM_IN "version" "CORBA::VersionSpec")
          ...
          :RESULT-TYPE "CORBA::OperationDef" :EXCEPTIONS NIL))
