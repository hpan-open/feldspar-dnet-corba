...
(EVAL-WHEN (:COMPILE-TOPLEVEL :LOAD-TOPLEVEL :EXECUTE)
  (PROGN (ENSURE-CORBA-PACKAGE
           ...
           '("NAMINGCONTEXTEXT/RESOLVE_STR" "NAMINGCONTEXTEXT/TO_URL"
             ...
             "NAMINGCONTEXT/BIND_CONTEXT" "NAMINGCONTEXT/REBIND"
             "NAMINGCONTEXT/BIND" "NAMINGCONTEXT/NOTEMPTY"
             "NAMINGCONTEXT/ALREADYBOUND" "NAMINGCONTEXT/INVALIDNAME"
             "NAMINGCONTEXT/CANNOTPROCEED" "NAMINGCONTEXT/NOTFOUND"
             "NAMINGCONTEXT/NOTFOUNDREASON" "NAMINGCONTEXT-PROXY"
             "NAMINGCONTEXT" "BINDINGITERATOR/DESTROY" "BINDINGITERATOR/NEXT_N"
             "BINDINGITERATOR/NEXT_ONE" "BINDINGITERATOR-PROXY"
             "BINDINGITERATOR" "BINDINGLIST" "BINDING" "BINDINGTYPE" "NAME"
             "NAMECOMPONENT" "ISTRING"))))
...
(DEFINE-STRUCT COSNAMING:BINDING
  ...
  :READ ((BUFFER)
         (COSNAMING:BINDING
          :BINDING_NAME (UNMARSHAL-SEQUENCE
                          (LAMBDA (BUFFER)
                            (STRUCT-READ 'COSNAMING:NAMECOMPONENT BUFFER))
                          BUFFER)
          :BINDING_TYPE (UNMARSHAL (%SYMBOL-TYPECODE COSNAMING:BINDINGTYPE)
                                   BUFFER)))
  :WRITE ((OBJ BUFFER)
          (MARSHAL-SEQUENCE
...
(DEFINE-METHOD "NEW_CONTEXT" ((OBJ COSNAMING:NAMINGCONTEXT-PROXY))
  (STATIC-CALL ("new_context" OBJ)
    :OUTPUT ((OUTPUT))
    :INPUT ((INPUT)
            (UNMARSHAL-OBJECT INPUT "IDL:omg.org/CosNaming/NamingContext:1.0"))
    :EXCEPTIONS NIL))
...
(DEFINE-METHOD "TO_URL" ((OBJ COSNAMING:NAMINGCONTEXTEXT-PROXY) _ADDR _SN)
  (STATIC-CALL ("to_url" OBJ)
    :OUTPUT ((OUTPUT) (MARSHAL-STRING _ADDR OUTPUT)
             (MARSHAL-STRING _SN OUTPUT))
    :INPUT ((INPUT) (UNMARSHAL-STRING INPUT))
