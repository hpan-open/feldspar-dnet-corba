...
(defpackage "OMG.ORG/CORBA"
  ...
  (:export
   ...
   "COMM_FAILURE" "CONSTANTDEF" "CONSTANTDEF-PROXY" "CONSTANTDESCRIPTION"
   "CONTAINED" "CONTAINED-PROXY" "CONTAINED/DESCRIPTION" "CONTAINEDSEQ"
   "CONTAINER" "CONTAINER-PROXY" "CONTAINER/DESCRIPTION"
   ...
   "IDENTIFIER" "IDLTYPE" "IDLTYPE-PROXY" "IDLTYPESEQ" "IMP_LIMIT" "INITIALIZE"
   "INTERFACEDEF" "INTERFACEDEF-PROXY" "INTERFACEDEF/FULLINTERFACEDESCRIPTION"
   "INTERFACEDEFSEQ" "INTERFACEDESCRIPTION" "INTERNAL" "INTF_REPOS"
   "INVALID_TRANSACTION" "INV_FLAG" "INV_IDENT" "INV_OBJREF" "IROBJECT"
   "IROBJECT-PROXY" "LONG" "LONGDOUBLE" "LONGLONG" "MARSHAL" "MODULEDEF"
   "MODULEDEF-PROXY" "MODULEDESCRIPTION" "NAMEDVALUE" "NO_IMPLEMENT"
   "NO_MEMORY" "NO_PERMISSION" "NO_RESOURCES" "NO_RESPONSE" "OBJECT"
   "OBJECT_NOT_EXIST" "OBJ_ADAPTER" "OCTET" "OPDESCRIPTIONSEQ" "OPERATIONDEF"
   "OPERATIONDEF-PROXY" "OPERATIONDESCRIPTION" "OPERATIONMODE" "ORB"
   "ORB/INVALIDNAME" "ORB_INIT" "PARAMETERDESCRIPTION" "PARAMETERMODE"
   "PARDESCRIPTIONSEQ" "PERSIST_STORE" "POLICY" "POLICY-PROXY" "POLICYERROR"
   "POLICYERRORCODE" "POLICYLIST" "POLICYTYPE" "PRIMITIVEDEF"
   "PRIMITIVEDEF-PROXY" "PRIMITIVEKIND" "PROXY" "REPOSITORY" "REPOSITORY-PROXY"
   "REPOSITORYID" "REPOSITORYIDSEQ" "REQUEST" "SCOPEDNAME" "SECURITY"
   "SEQUENCEDEF" "SEQUENCEDEF-PROXY" "SERVICEDETAIL" "SERVICEDETAILTYPE"
   "SERVICEINFORMATION" "SERVICEOPTION" "SERVICETYPE" "SHORT" "STRING"
   "STRINGDEF" "STRINGDEF-PROXY" "STRUCT" "STRUCTDEF" "STRUCTDEF-PROXY"
   "STRUCTMEMBER" "STRUCTMEMBERSEQ" "SYSTEMEXCEPTION" "TCKIND" "TC_ALIAS"
   "TC_ANY" "TC_ARRAY" "TC_BOOLEAN" "TC_CHAR" "TC_DOUBLE" "TC_ENUM" "TC_EXCEPT"
   "TC_FIXED" "TC_FLOAT" "TC_LONG" "TC_LONGDOUBLE" "TC_LONGLONG" "TC_NULL"
   "TC_OBJREF" "TC_OCTET" "TC_PRINCIPAL" "TC_SEQUENCE" "TC_SHORT" "TC_STRING"
   "TC_STRUCT" "TC_TYPECODE" "TC_ULONG" "TC_ULONGLONG" "TC_UNION" "TC_USHORT"
   "TC_VOID" "TC_WCHAR" "TC_WSTRING" "TRANSACTION_REQUIRED"
   "TRANSACTION_ROLLEDBACK" "TRANSIENT" "TYPECODE" "TYPECODE/BADKIND"
   "TYPECODE/BOUNDS" "TYPEDEFDEF" "TYPEDEFDEF-PROXY" "TYPEDESCRIPTION" "ULONG"
   "ULONGLONG" "UNION" "UNIONDEF" "UNIONDEF-PROXY" "UNIONMEMBER"
   "UNIONMEMBERSEQ" "UNKNOWN" "UNSUPPORTED_POLICY" "UNSUPPORTED_POLICY_VALUE"
   "USEREXCEPTION" "USHORT" "VERSIONSPEC" "WCHAR" "WSTRING" "WSTRINGDEF"
   "WSTRINGDEF-PROXY"))
