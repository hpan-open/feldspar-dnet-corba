...
(defpackage "OMG.ORG/CORBA"
  ...
  (:nicknames "CORBA")
  (:export
   "ABSTRACTBASE" "ABSTRACTINTERFACEDEF" "ABSTRACTINTERFACEDEF-PROXY" "ABSTRACTINTERFACEDEFSEQ"
   "ALIASDEF" "ALIASDEF-PROXY" "ALIASDEF/ORIGINAL_TYPE_DEF" "ANY" "ANY-TYPECODE" "ANY-VALUE"
   "ARG_IN" "ARG_INOUT" "ARG_OUT" "ARRAYDEF" "ARRAYDEF-PROXY" "ARRAYDEF/ELEMENT_TYPE"
   "ARRAYDEF/ELEMENT_TYPE_DEF" "ARRAYDEF/LENGTH" "ATTRDESCRIPTIONSEQ" "ATTRIBUTEDEF"
   "ATTRIBUTEDEF-PROXY" "ATTRIBUTEDEF/MODE" "ATTRIBUTEDEF/TYPE" "ATTRIBUTEDEF/TYPE_DEF"
   "ATTRIBUTEDESCRIPTION" "ATTRIBUTEMODE" "BAD_CONTEXT" "BAD_INV_ORDER" "BAD_OPERATION"
   "BAD_PARAM" "BAD_POLICY" "BAD_POLICY_TYPE" "BAD_POLICY_VALUE" "BAD_TYPECODE" "BOOLEAN"
   "CHAR" "COMM_FAILURE" "COMPLETION_STATUS" "CONSTANTDEF" "CONSTANTDEF-PROXY"
   "CONSTANTDEF/TYPE" "CONSTANTDEF/TYPE_DEF" "CONSTANTDEF/VALUE" "CONSTANTDESCRIPTION"
   "CONTAINED" "CONTAINED-PROXY" "CONTAINED/ABSOLUTE_NAME" "CONTAINED/CONTAINING_REPOSITORY"
   ...
   "CONTAINER/CREATE_EXCEPTION" "CONTAINER/CREATE_INTERFACE" "CONTAINER/CREATE_LOCAL_INTERFACE"
   "CONTAINER/CREATE_MODULE" "CONTAINER/CREATE_NATIVE" "CONTAINER/CREATE_STRUCT"
   "CONTAINER/CREATE_UNION" "CONTAINER/CREATE_VALUE" "CONTAINER/CREATE_VALUE_BOX"
   "CONTAINER/DESCRIBE_CONTENTS" "CONTAINER/DESCRIPTION" "CONTAINER/DESCRIPTIONSEQ"
   "CONTAINER/LOOKUP" "CONTAINER/LOOKUP_NAME" "CONTEXTIDENTIFIER" "CONTEXTIDSEQ"
   "CTX_RESTRICT_SCOPE" "CURRENT" "DATA_CONVERSION" "DEFINE-METHOD" "DEFINITIONKIND" "DOUBLE"
   "ENUMDEF" "ENUMDEF-PROXY" "ENUMDEF/MEMBERS" "ENUMMEMBERSEQ" "ENVIRONMENT"
   "EXCDESCRIPTIONSEQ" "EXCEPTION" "EXCEPTIONDEF" "EXCEPTIONDEF-PROXY" "EXCEPTIONDEF/MEMBERS"
   "EXCEPTIONDEF/TYPE" "EXCEPTIONDEFSEQ" "EXCEPTIONDESCRIPTION" "FIXED" "FIXEDDEF"
   "FIXEDDEF-PROXY" "FIXEDDEF/DIGITS" "FIXEDDEF/SCALE" "FLAGS" "FLOAT" "FREE_MEM" "FUNCALL"
   "IDENTIFIER" "IDL" "IDLTYPE" "IDLTYPE-PROXY" "IDLTYPE/TYPE" "IDLTYPESEQ" "IMP_LIMIT"
   "INITIALIZE" "INITIALIZER" "INITIALIZERSEQ" "INTERFACEDEF" "INTERFACEDEF-PROXY"
   ...
   "LONGLONG" "MARSHAL" "MODULEDEF" "MODULEDEF-PROXY" "MODULEDESCRIPTION" "NAMEDVALUE"
   "NATIVEDEF" "NATIVEDEF-PROXY" "NO_IMPLEMENT" "NO_MEMORY" "NO_PERMISSION" "NO_RESOURCES"
   "NO_RESPONSE" "OBJECT" "OBJECT_NOT_EXIST" "OBJ_ADAPTER" "OCTET" "OPDESCRIPTIONSEQ"
   "OPERATIONDEF" "OPERATIONDEF-PROXY" "OPERATIONDEF/CONTEXTS" "OPERATIONDEF/EXCEPTIONS"
   "OPERATIONDEF/MODE" "OPERATIONDEF/PARAMS" "OPERATIONDEF/RESULT" "OPERATIONDEF/RESULT_DEF"
   "OPERATIONDESCRIPTION" "OPERATIONMODE" "ORB" "ORB/INVALIDNAME" "ORBID" "ORB_INIT"
   "PARAMETERDESCRIPTION" "PARAMETERMODE" "PARDESCRIPTIONSEQ" "PERSIST_STORE" "POLICY"
   "POLICY-PROXY" "POLICYERROR" "POLICYERRORCODE" "POLICYLIST" "POLICYTYPE" "PRIMITIVEDEF"
   "PRIMITIVEDEF-PROXY" "PRIMITIVEDEF/KIND" "PRIMITIVEKIND" "PRIVATE_MEMBER" "PROXY"
   "PUBLIC_MEMBER" "REPOSITORY" "REPOSITORY-PROXY" "REPOSITORY/CREATE_ARRAY"
   "REPOSITORY/CREATE_FIXED" "REPOSITORY/CREATE_SEQUENCE" "REPOSITORY/CREATE_STRING"
   "REPOSITORY/CREATE_WSTRING" "REPOSITORY/GET_CANONICAL_TYPECODE" "REPOSITORY/GET_PRIMITIVE"
   "REPOSITORY/LOOKUP_ID" "REPOSITORYID" "REPOSITORYIDSEQ" "REQUEST" "SCOPEDNAME"
   "SECCONSTRUCTION" "SECURITY" "SEQUENCEDEF" "SEQUENCEDEF-PROXY" "SEQUENCEDEF/BOUND"
   "SEQUENCEDEF/ELEMENT_TYPE" "SEQUENCEDEF/ELEMENT_TYPE_DEF" "SERVERREQUEST" "SERVICEDETAIL"
   "SERVICEDETAILTYPE" "SERVICEINFORMATION" "SERVICEOPTION" "SERVICETYPE" "SHORT" "STRING"
   "STRINGDEF" "STRINGDEF-PROXY" "STRINGDEF/BOUND" "STRINGSEQ" "STRUCT" "STRUCTDEF"
   "STRUCTDEF-PROXY" "STRUCTDEF/MEMBERS" "STRUCTMEMBER" "STRUCTMEMBERSEQ" "SYSTEMEXCEPTION"
   "TCKIND" "TC_ALIAS" "TC_ANY" "TC_ARRAY" "TC_BOOLEAN" "TC_CHAR" "TC_COMPLETION_STATUS"
   "TC_DOUBLE" "TC_ENUM" "TC_EXCEPT" "TC_FIXED" "TC_FLOAT" "TC_LONG" "TC_LONGDOUBLE"
   "TC_LONGLONG" "TC_NULL" "TC_OBJECT" "TC_OCTET" "TC_PRINCIPAL" "TC_SEQUENCE" "TC_SHORT"
   "TC_STRING" "TC_STRUCT" "TC_TYPECODE" "TC_ULONG" "TC_ULONGLONG" "TC_UNION" "TC_USHORT"
   "TC_VALUEBASE" "TC_VOID" "TC_WCHAR" "TC_WSTRING" "TRANSACTION_REQUIRED"
   "TRANSACTION_ROLLEDBACK" "TRANSIENT" "TYPECODE" "TYPECODE-PROXY" "TYPECODE/BADKIND"
   "TYPECODE/BOUNDS" "TYPECODEFACTORY" "TYPEDEFDEF" "TYPEDEFDEF-PROXY" "TYPEDESCRIPTION"
   "ULONG" "ULONGLONG" "UNION" "UNIONDEF" "UNIONDEF-PROXY" "UNIONDEF/DISCRIMINATOR_TYPE"
   "UNIONDEF/DISCRIMINATOR_TYPE_DEF" "UNIONDEF/MEMBERS" "UNIONMEMBER" "UNIONMEMBERSEQ"
   "UNKNOWN" "UNSUPPORTED_POLICY" "UNSUPPORTED_POLICY_VALUE" "USEREXCEPTION" "USHORT"
   "VALUEBASE" "VALUEBOXDEF" "VALUEBOXDEF-PROXY" "VALUEBOXDEF/ORIGINAL_TYPE_DEF" "VALUEDEF"
   "VALUEDEF-PROXY" "VALUEDEF/ABSTRACT_BASE_VALUES" "VALUEDEF/BASE_VALUE"
   "VALUEDEF/CREATE_ATTRIBUTE" "VALUEDEF/CREATE_OPERATION" "VALUEDEF/CREATE_VALUE_MEMBER"
   "VALUEDEF/DESCRIBE_VALUE" "VALUEDEF/FULLVALUEDESCRIPTION" "VALUEDEF/INITIALIZERS"
   "VALUEDEF/IS_A" "VALUEDEF/IS_ABSTRACT" "VALUEDEF/IS_CUSTOM" "VALUEDEF/IS_TRUNCATABLE"
   ...
   "VM_ABSTRACT" "VM_CUSTOM" "VM_NONE" "VM_TRUNCATABLE" "WCHAR" "WSTRING" "WSTRINGDEF"
   "WSTRINGDEF-PROXY" "WSTRINGDEF/BOUND"))
...
(defpackage "OMG.ORG/IOP"
  ...
  (:nicknames "IOP")
  (:export
   "ENCODINGFORMAT" "ENCODING_CDR_ENCAPS" "ENCODING" "CODEC" "CODEC/INVALIDTYPEFORENCODING"
   "CODEC/FORMATMISMATCH" "CODEC/TYPEMISMATCH" "CODEC/TYPEMISMATCH" "CODECFACTORY"
   "CODECFACTORY/UNKNOWNENCODING"
