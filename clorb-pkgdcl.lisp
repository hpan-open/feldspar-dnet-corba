...
(defpackage "OMG.ORG/CORBA"
  (:use)
  (:nicknames "CORBA")
  (:export "ORBID" #:tc_completion_status #:ValueBase #:AbstractBase 
   "ABSTRACTINTERFACEDEF" "ABSTRACTINTERFACEDEF-PROXY" "ABSTRACTINTERFACEDEFSEQ" "ALIASDEF"
   "ALIASDEF-PROXY" "ALIASDEF/ORIGINAL_TYPE_DEF" "ANY" "ANY-TYPECODE" "ANY-VALUE" "ARG_IN"
   "ARG_INOUT" "ARG_OUT" "ARRAYDEF" "ARRAYDEF-PROXY" "ARRAYDEF/ELEMENT_TYPE"
   ...
   "STRINGDEF" "STRINGDEF-PROXY" "STRINGDEF/BOUND" "STRUCT" "STRUCTDEF" "STRUCTDEF-PROXY"
   "STRUCTDEF/MEMBERS" "STRUCTMEMBER" "STRUCTMEMBERSEQ" "SYSTEMEXCEPTION" "TCKIND" "TC_ALIAS"
   "TC_ANY" "TC_ARRAY" "TC_BOOLEAN" "TC_CHAR" "TC_DOUBLE" "TC_ENUM" "TC_EXCEPT" "TC_FIXED"
   "TC_FLOAT" "TC_LONG" "TC_LONGDOUBLE" "TC_LONGLONG" "TC_NULL" "TC_OBJECT" "TC_OCTET"
   "TC_PRINCIPAL" "TC_SEQUENCE" "TC_SHORT" "TC_STRING" "TC_STRUCT" "TC_TYPECODE" "TC_ULONG"
   "TC_ULONGLONG" "TC_UNION" "TC_USHORT" "TC_VALUEBASE" "TC_VOID" "TC_WCHAR" "TC_WSTRING"
   ...
   "UNIONDEF/DISCRIMINATOR_TYPE" "UNIONDEF/DISCRIMINATOR_TYPE_DEF" "UNIONDEF/MEMBERS"
   "UNIONMEMBER" "UNIONMEMBERSEQ" "UNKNOWN" "UNSUPPORTED_POLICY" "UNSUPPORTED_POLICY_VALUE"
   "USEREXCEPTION" "USHORT" "VALUEBOXDEF" "VALUEBOXDEF-PROXY" "VALUEBOXDEF/ORIGINAL_TYPE_DEF"
   "VALUEDEF" "VALUEDEF-PROXY" "VALUEDEF/ABSTRACT_BASE_VALUES" "VALUEDEF/BASE_VALUE"
