...
(defpackage "OMG.ORG/CORBA"
  ...
  (:export
   ...
   "TC_LONGLONG" "TC_NULL" "TC_OBJREF" "TC_OCTET" "TC_PRINCIPAL" "TC_SEQUENCE"
...
(defpackage "OMG.ORG/PORTABLESERVER"
  ...
  (:export
   "ADAPTERACTIVATOR" "CURRENT" "CURRENT/NOCONTEXT" "DYNAMICIMPLEMENTATION"
   "FORWARDREQUEST" "OID-TO-STRING" "POA" "POA/ADAPTERALREADYEXISTS"
   "POA/ADAPTERINACTIVE" "POA/ADAPTERNONEXISTENT" "POA/INVALIDPOLICY"
   "POA/NOSERVANT" "POA/OBJECTALREADYACTIVE" "POA/OBJECTNOTACTIVE"
   "POA/SERVANTALREADYACTIVE" "POA/SERVANTNOTACTIVE" "POA/WRONGADAPTER"
   "POA/WRONGPOLICY" "POAMANAGER" "POAMANAGER/ADAPTERINACTIVE" "SERVANT"
   "SERVANTACTIVATOR" "SERVANTLOCATOR" "SERVANTLOCATOR/COOKIE" "SERVANTMANAGER"
   "STRING-TO-OID"))
