...
(defmethod servant-active-p ((aom object-map) servant)
  (gethash servant (servant-activation-hash aom)))
...
(defmethod map-activations ((aom object-map) func)
  (loop for activation-list being the hash-values of (servant-activation-hash aom)
